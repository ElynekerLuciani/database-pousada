/*
Banco de dados relacional MySQL do projeto pousada.
Este arquivo possui uma licenca open source GNU GPL v3.0.
Autor: Elyneker Luciani
elyneker@gmail.com
*/

-- CRIANDO O BANCO DE DADOS
CREATE DATABASE  IF NOT EXISTS `projeto_pousada` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `projeto_pousada`;

-- CRIANDO TABELA CATEGORIA QUARTO
CREATE TABLE IF NOT EXISTS Categoria_Quarto(
	id_categoria_quarto INT NOT NULL AUTO_INCREMENT,
    nome_categoria VARCHAR(45) NOT NULL,
    status_categoria BOOL DEFAULT (1),
...
CREATE TABLE IF NOT EXISTS Quarto(
    ...
    sujo BOOL DEFAULT(0),
    status_quarto BOOL DEFAULT (1),
    PRIMARY KEY (id_quarto),
    FOREIGN KEY (id_categoria) REFERENCES Categoria_Quarto(id_categoria_quarto)
);

-- CRIANDO PREÇOS DE QUARTO
CREATE TABLE IF NOT EXISTS Valor_Categoria(
	id_valor_categoria INT NOT NULL AUTO_INCREMENT,
    valor_categoria DECIMAL(10,2) NOT NULL,
    qnt_hospede INT NOT NULL,
    id_categoria INT NOT NULL,
    status_categoria BOOL DEFAULT(1),
    PRIMARY KEY(id_valor_categoria),
    FOREIGN KEY (id_categoria) REFERENCES Categoria_Quarto(id_categoria_quarto) ON DELETE CASCADE,
	CONSTRAINT chave UNIQUE (qnt_hospede, id_categoria)
);

-- CRIAMOS A TABELA DE ESTADOS DO BRASIL
...
-- CRIAMOS A TABELA QUE CONTÉM TODAS AS CIDADES E SUA REFERENCIA A UM ESTADO DO BRASIL
CREATE TABLE IF NOT EXISTS Cidade (
  ...
  CONSTRAINT chave UNIQUE(nome, estado)
);
...
CREATE TABLE IF NOT EXISTS Documento(
    ...
    UNIQUE(documento),
    FOREIGN KEY(id_tipo) REFERENCES Tipo_Documento(id_tipo_documento)
);
...
-- CRIANDO TABELA DE CATEGORIA DE PRODUTOS
CREATE TABLE IF NOT EXISTS Categoria_Produto(
	id_cat_produto INT NOT NULL AUTO_INCREMENT,
    nome_categoria VARCHAR(45) NOT NULL,
...
-- CRIANDO A TABELA DE RECIBO FINANCEIRO
...
-- CRIANDO A TABELA DE TIPO MOVIMENTACAO
CREATE TABLE IF NOT EXISTS Tipo_Movimentacao(
    ...
    UNIQUE(tipo_movimentacao)
);

-- CRIANDO A TABELA CAIXA FINANCEIRO
CREATE TABLE IF NOT EXISTS Caixa_Financeiro(
    ...
    FOREIGN KEY(tipo_movimentacao) REFERENCES Tipo_Movimentacao(id_tipo_movimentacao)
);

-- CRIANDO CATEGORIAS DE MOVIMENTACAO
INSERT INTO Tipo_Movimentacao(tipo_movimentacao) VALUES('Entrada');
INSERT INTO Tipo_Movimentacao(tipo_movimentacao) VALUES('Saída');

-- CRINDO CATEGORIAS DE QUARTOS
INSERT INTO Categoria_Quarto(nome_categoria) VALUES('Ventilador');
INSERT INTO Categoria_Quarto(nome_categoria) VALUES('Ar-condicionado');

-- CRIANDO CATEGORIAS DE PRODUTOS
INSERT INTO Categoria_Produto(nome_categoria) VALUES('Refrigerante');
INSERT INTO Categoria_Produto(nome_categoria) VALUES('Cerveja');
INSERT INTO Categoria_Produto(nome_categoria) VALUES('Água Mineral');
INSERT INTO Categoria_Produto(nome_categoria) VALUES('Suco');
INSERT INTO Categoria_Produto(nome_categoria) VALUES('Achocolatado');

-- CRIANDO VALORES DE CATEGORIAS
INSERT INTO Valor_Categoria(valor_categoria, qnt_hospede, id_categoria)VALUES(30.00, 1, 1);
INSERT INTO Valor_Categoria(valor_categoria, qnt_hospede, id_categoria)VALUES(45.00, 2, 1);
INSERT INTO Valor_Categoria(valor_categoria, qnt_hospede, id_categoria)VALUES(55.90, 3, 1);
INSERT INTO Valor_Categoria(valor_categoria, qnt_hospede, id_categoria)VALUES(65.00, 1, 2);
INSERT INTO Valor_Categoria(valor_categoria, qnt_hospede, id_categoria)VALUES(75.90, 2, 2);
INSERT INTO Valor_Categoria(valor_categoria, qnt_hospede, id_categoria)VALUES(90.00, 3, 2);
INSERT INTO Valor_Categoria(valor_categoria, qnt_hospede, id_categoria)VALUES(100.00, 4, 2);

-- CRIANDO QUARTOS
INSERT INTO Quarto(numero_quarto, id_categoria) VALUES(1, 2);
INSERT INTO Quarto(numero_quarto, id_categoria) VALUES(2, 2);
INSERT INTO Quarto(numero_quarto, id_categoria) VALUES(3, 1);
INSERT INTO Quarto(numero_quarto, id_categoria) VALUES(4, 1);
INSERT INTO Quarto(numero_quarto, id_categoria) VALUES(5, 1);
INSERT INTO Quarto(numero_quarto, id_categoria) VALUES(6, 1);
INSERT INTO Quarto(numero_quarto, id_categoria) VALUES(7, 2);
INSERT INTO Quarto(numero_quarto, id_categoria) VALUES(8, 1);
INSERT INTO Quarto(numero_quarto, id_categoria) VALUES(9, 2);
INSERT INTO Quarto(numero_quarto, id_categoria) VALUES(10, 2);
INSERT INTO Quarto(numero_quarto, id_categoria) VALUES(11, 2);
INSERT INTO Quarto(numero_quarto, id_categoria) VALUES(12, 1);
INSERT INTO Quarto(numero_quarto, id_categoria) VALUES(13, 1);
INSERT INTO Quarto(numero_quarto, id_categoria) VALUES(14, 2);
INSERT INTO Quarto(numero_quarto, id_categoria) VALUES(15, 1);
INSERT INTO Quarto(numero_quarto, id_categoria) VALUES(16, 2);
INSERT INTO Quarto(numero_quarto, id_categoria) VALUES(17, 2);
INSERT INTO Quarto(numero_quarto, id_categoria) VALUES(18, 2);
INSERT INTO Quarto(numero_quarto, id_categoria) VALUES(19, 2);
INSERT INTO Quarto(numero_quarto, id_categoria) VALUES(20, 2);

-- CRIANDO TIPOS DE DOCUMENTOS
INSERT INTO tipo_documento(tipo_documento) VALUES('CPF');
INSERT INTO tipo_documento(tipo_documento) VALUES('CNPJ');
INSERT INTO tipo_documento(tipo_documento) VALUES('PASSAPORTE');

-- CRIANDO OS TIPOS DE CLIENTES
INSERT INTO tipo_cliente(tipo_cliente) VALUES('Pessoa Física');
INSERT INTO tipo_cliente(tipo_cliente) VALUES('Pessoa Jurídica');
INSERT INTO tipo_cliente(tipo_cliente) VALUES('Estrangeiro');
...
-- CRIANDO TODAS AS CIDADES BRASILEIRAS
INSERT INTO Cidade (idAntigo, nome, estado) VALUES
(1, 'Afonso Cláudio', 8),
